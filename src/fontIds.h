...
#define UI_10_FONT_ID (264421873)
#define UI_12_FONT_ID (1250829832)
#define SMALL_FONT_ID (25639319)
#define NOTOSANSJP_18_FONT_ID (999999999)
#define UBUNTU_JP_10_FONT_ID (111111111)
#define UBUNTU_JP_12_FONT_ID (222222222)
